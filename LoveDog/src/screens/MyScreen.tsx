...
export const MyScreen : React.FC = () => {
    ...
    const userInfo = useSelector<TypeRootReducer, TypeUser | null>((state) => state.user.user);
    console.log('MyScreen userInfo:', userInfo);
    return(
        <View style={{flex:1}}>
            <Header>
            ...
            <View style={{flex:1}}>
                ...
                <Button onPress={()=> {
                    ...
                    <View style={{backgroundColor:'white',paddingVertical:12, paddingHorizontal: 8, flexDirection:'row', justifyContent : 'space-between',alignItems:'center'}}>
